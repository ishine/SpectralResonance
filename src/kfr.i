...
%template(FloatComplex) std::complex<float>;
%template(DoubleComplex) std::complex<double>;
...
%template(bessel_lowpassf) bessel_lowpass<f64>;
%template(bessel_highpassf) bessel_highpass<f64>;
%template(bessel_bandpassf) bessel_bandpass<f64>;
%template(bessel_bandstopf) bessel_bandstop<f64>;

%template(butterworth_lowpassf) butterworth_lowpass<f64>;
%template(butterworth_highpassf) butterworth_highpass<f64>;
%template(butterworth_bandpassf) butterworth_bandpass<f64>;
%template(butterworth_bandstopf) butterworth_bandstop<f64>;

%template(chebyshev1_lowpassf) chebyshev1_lowpass<f64>;
%template(chebyshev1_highpassf) chebyshev1_highpass<f64>;
%template(chebyshev1_bandpassf) chebyshev1_bandpass<f64>;
%template(chebyshev1_bandstopf) chebyshev1_bandstop<f64>;

%template(chebyshev2_lowpassf)  chebyshev2_lowpass<f64>;
%template(chebyshev2_highpassf) chebyshev2_highpass<f64>;
%template(chebyshev2_bandpassf) chebyshev2_bandpass<f64>;
%template(chebyshev2_bandstopf) chebyshev2_bandstop<f64>;

%template (convolvef) convolve<float>;
