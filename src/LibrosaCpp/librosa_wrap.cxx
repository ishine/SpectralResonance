...
#define SWIGTYPE_p_Eigen__MatrixT_float_1_Eigen__Dynamic_Eigen__RowMajor_t swig_types[0]
#define SWIGTYPE_p_Eigen__MatrixT_float_Eigen__Dynamic_Eigen__Dynamic_Eigen__RowMajor_t swig_types[1]
#define SWIGTYPE_p_Eigen__MatrixT_std__complexT_float_t_1_Eigen__Dynamic_Eigen__RowMajor_t swig_types[2]
#define SWIGTYPE_p_Eigen__MatrixT_std__complexT_float_t_Eigen__Dynamic_Eigen__Dynamic_Eigen__RowMajor_t swig_types[3]
#define SWIGTYPE_p_difference_type swig_types[4]
#define SWIGTYPE_p_librosa__Feature swig_types[5]
...
#define SWIGTYPE_p_std__vectorT_std__complexT_float_t_t swig_types[10]
#define SWIGTYPE_p_std__vectorT_std__vectorT_float_t_t swig_types[11]
#define SWIGTYPE_p_std__vectorT_std__vectorT_std__complexT_float_t_t_t swig_types[12]
...
#define SWIG_name      "librosa"
#define SWIG_init      luaopen_librosa
#define SWIG_init_user luaopen_librosa_user

#define SWIG_LUACODE   luaopen_librosa_luacode
...
SWIGINTERN std::vector< std::complex< float > > std_vector_Sl_std_vector_Sl_std_complex_Sl_float_Sg__Sg__Sg____getitem____SWIG(std::vector< std::vector< std::complex< float > > > *self,unsigned int idx){
				if (idx>=self->size())
					throw std::out_of_range("in vector::__getitem__()");
				return (*self)[idx];
			}
SWIGINTERN void std_vector_Sl_std_vector_Sl_std_complex_Sl_float_Sg__Sg__Sg____setitem____SWIG(std::vector< std::vector< std::complex< float > > > *self,unsigned int idx,std::vector< std::complex< float > > val){
				if (idx>=self->size())
					throw std::out_of_range("in vector::__setitem__()");
				(*self)[idx]=val;
			}
...
static int _wrap_new_complex_matrix__SWIG_0(lua_State* L) {
  ...
  SWIG_check_num_args("std::vector< std::vector< std::complex< float > > >::vector",0,0)
  result = (std::vector< std::vector< std::complex< float > > > *)new std::vector< std::vector< std::complex< float > > >();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_std__vectorT_std__vectorT_std__complexT_float_t_t_t,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_new_complex_matrix__SWIG_1(lua_State* L) {
  ...
  SWIG_check_num_args("std::vector< std::vector< std::complex< float > > >::vector",1,1)
  if(!lua_isnumber(L,1)) SWIG_fail_arg("std::vector< std::vector< std::complex< float > > >::vector",1,"unsigned int");
  SWIG_contract_assert((lua_tonumber(L,1)>=0),"number must not be negative");
  arg1 = (unsigned int)lua_tonumber(L, 1);
...
static int _wrap_new_complex_matrix__SWIG_2(lua_State* L) {
  int SWIG_arg = 0;
  std::vector< std::vector< std::complex< float > > > *arg1 = 0 ;
  std::vector< std::vector< std::complex< float > > > *result = 0 ;
  
  SWIG_check_num_args("std::vector< std::vector< std::complex< float > > >::vector",1,1)
  if(!lua_isuserdata(L,1)) SWIG_fail_arg("std::vector< std::vector< std::complex< float > > >::vector",1,"std::vector< std::vector< std::complex< float > > > const &");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_std__vectorT_std__vectorT_std__complexT_float_t_t_t,0))){
    SWIG_fail_ptr("new_complex_matrix",1,SWIGTYPE_p_std__vectorT_std__vectorT_std__complexT_float_t_t_t);
  }
  
  result = (std::vector< std::vector< std::complex< float > > > *)new std::vector< std::vector< std::complex< float > > >((std::vector< std::vector< std::complex< float > > > const &)*arg1);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_std__vectorT_std__vectorT_std__complexT_float_t_t_t,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_new_complex_matrix__SWIG_3(lua_State* L) {
  int SWIG_arg = 0;
  unsigned int arg1 ;
  SwigValueWrapper< std::vector< std::complex< float > > > arg2 ;
  std::vector< std::complex< float > > *argp2 ;
  std::vector< std::vector< std::complex< float > > > *result = 0 ;
  
  SWIG_check_num_args("std::vector< std::vector< std::complex< float > > >::vector",2,2)
  if(!lua_isnumber(L,1)) SWIG_fail_arg("std::vector< std::vector< std::complex< float > > >::vector",1,"unsigned int");
  if(!lua_isuserdata(L,2)) SWIG_fail_arg("std::vector< std::vector< std::complex< float > > >::vector",2,"std::vector< std::complex< float > >");
  SWIG_contract_assert((lua_tonumber(L,1)>=0),"number must not be negative");
  arg1 = (unsigned int)lua_tonumber(L, 1);
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&argp2,SWIGTYPE_p_std__vectorT_std__complexT_float_t_t,0))){
    SWIG_fail_ptr("new_complex_matrix",2,SWIGTYPE_p_std__vectorT_std__complexT_float_t_t);
  }
  arg2 = *argp2;
  
  result = (std::vector< std::vector< std::complex< float > > > *)new std::vector< std::vector< std::complex< float > > >(arg1,arg2);
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_std__vectorT_std__vectorT_std__complexT_float_t_t_t,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_new_complex_matrix(lua_State* L) {
  ...
  if (argc == 1) {
    ...
    {
      void *ptr;
      if (lua_isuserdata(L,argv[0])==0 || SWIG_ConvertPtr(L,argv[0], (void **) &ptr, SWIGTYPE_p_std__vectorT_std__vectorT_std__complexT_float_t_t_t, SWIG_POINTER_NO_NULL)) {
        _v = 0;
      } else {
        _v = 1;
      }
    ...
    if (_v) {
      return _wrap_new_complex_matrix__SWIG_2(L);
    }
  }
  if (argc == 1) {
    int _v = 0;
  ...
  if (argc == 2) {
    ...
    if (_v) {
      ...
      if (_v) {
        return _wrap_new_complex_matrix__SWIG_3(L);
      }
    }
  }
  ...
  SWIG_Lua_pusherrstring(L,"Wrong arguments for overloaded function 'new_complex_matrix'\n"
    ...
    "    std::vector< std::vector< std::complex< float > > >::vector(unsigned int)\n"
    "    std::vector< std::vector< std::complex< float > > >::vector(std::vector< std::vector< std::complex< float > > > const &)\n"
    "    std::vector< std::vector< std::complex< float > > >::vector(unsigned int,std::vector< std::complex< float > >)\n");
  lua_error(L);return 0;
}
...
static int _wrap_complex_matrix_size(lua_State* L) {
  ...
  SWIG_check_num_args("std::vector< std::vector< std::complex< float > > >::size",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("std::vector< std::vector< std::complex< float > > >::size",1,"std::vector< std::vector< std::complex< float > > > const *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_std__vectorT_std__vectorT_std__complexT_float_t_t_t,0))){
    SWIG_fail_ptr("complex_matrix_size",1,SWIGTYPE_p_std__vectorT_std__vectorT_std__complexT_float_t_t_t);
  }
  
  result = (unsigned int)((std::vector< std::vector< std::complex< float > > > const *)arg1)->size();
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_complex_matrix_max_size(lua_State* L) {
  ...
  SWIG_check_num_args("std::vector< std::vector< std::complex< float > > >::max_size",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("std::vector< std::vector< std::complex< float > > >::max_size",1,"std::vector< std::vector< std::complex< float > > > const *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_std__vectorT_std__vectorT_std__complexT_float_t_t_t,0))){
    SWIG_fail_ptr("complex_matrix_max_size",1,SWIGTYPE_p_std__vectorT_std__vectorT_std__complexT_float_t_t_t);
  }
  
  result = (unsigned int)((std::vector< std::vector< std::complex< float > > > const *)arg1)->max_size();
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_complex_matrix_empty(lua_State* L) {
  ...
  SWIG_check_num_args("std::vector< std::vector< std::complex< float > > >::empty",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("std::vector< std::vector< std::complex< float > > >::empty",1,"std::vector< std::vector< std::complex< float > > > const *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_std__vectorT_std__vectorT_std__complexT_float_t_t_t,0))){
    SWIG_fail_ptr("complex_matrix_empty",1,SWIGTYPE_p_std__vectorT_std__vectorT_std__complexT_float_t_t_t);
  }
...
static int _wrap_complex_matrix_clear(lua_State* L) {
  ...
  SWIG_check_num_args("std::vector< std::vector< std::complex< float > > >::clear",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("std::vector< std::vector< std::complex< float > > >::clear",1,"std::vector< std::vector< std::complex< float > > > *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_std__vectorT_std__vectorT_std__complexT_float_t_t_t,0))){
    SWIG_fail_ptr("complex_matrix_clear",1,SWIGTYPE_p_std__vectorT_std__vectorT_std__complexT_float_t_t_t);
  }
...
static int _wrap_complex_matrix_push_back(lua_State* L) {
  ...
  SWIG_check_num_args("std::vector< std::vector< std::complex< float > > >::push_back",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("std::vector< std::vector< std::complex< float > > >::push_back",1,"std::vector< std::vector< std::complex< float > > > *");
  if(!lua_isuserdata(L,2)) SWIG_fail_arg("std::vector< std::vector< std::complex< float > > >::push_back",2,"std::vector< std::complex< float > >");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_std__vectorT_std__vectorT_std__complexT_float_t_t_t,0))){
    SWIG_fail_ptr("complex_matrix_push_back",1,SWIGTYPE_p_std__vectorT_std__vectorT_std__complexT_float_t_t_t);
  }
  
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,2,(void**)&argp2,SWIGTYPE_p_std__vectorT_std__complexT_float_t_t,0))){
    SWIG_fail_ptr("complex_matrix_push_back",2,SWIGTYPE_p_std__vectorT_std__complexT_float_t_t);
  }
  arg2 = *argp2;
...
static int _wrap_complex_matrix_pop_back(lua_State* L) {
  ...
  SWIG_check_num_args("std::vector< std::vector< std::complex< float > > >::pop_back",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("std::vector< std::vector< std::complex< float > > >::pop_back",1,"std::vector< std::vector< std::complex< float > > > *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_std__vectorT_std__vectorT_std__complexT_float_t_t_t,0))){
    SWIG_fail_ptr("complex_matrix_pop_back",1,SWIGTYPE_p_std__vectorT_std__vectorT_std__complexT_float_t_t_t);
  }
...
static int _wrap_complex_matrix_front(lua_State* L) {
  ...
  SWIG_check_num_args("std::vector< std::vector< std::complex< float > > >::front",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("std::vector< std::vector< std::complex< float > > >::front",1,"std::vector< std::vector< std::complex< float > > > const *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_std__vectorT_std__vectorT_std__complexT_float_t_t_t,0))){
    SWIG_fail_ptr("complex_matrix_front",1,SWIGTYPE_p_std__vectorT_std__vectorT_std__complexT_float_t_t_t);
  }
  
  result = ((std::vector< std::vector< std::complex< float > > > const *)arg1)->front();
  {
...
static int _wrap_complex_matrix_back(lua_State* L) {
  ...
  SWIG_check_num_args("std::vector< std::vector< std::complex< float > > >::back",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("std::vector< std::vector< std::complex< float > > >::back",1,"std::vector< std::vector< std::complex< float > > > const *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_std__vectorT_std__vectorT_std__complexT_float_t_t_t,0))){
    SWIG_fail_ptr("complex_matrix_back",1,SWIGTYPE_p_std__vectorT_std__vectorT_std__complexT_float_t_t_t);
  }
  
  result = ((std::vector< std::vector< std::complex< float > > > const *)arg1)->back();
  {
    std::vector< std::complex< float > > * resultptr = new std::vector< std::complex< float > >((const std::vector< std::complex< float > > &) result);
    SWIG_NewPointerObj(L,(void *) resultptr,SWIGTYPE_p_std__vectorT_std__complexT_float_t_t,1); SWIG_arg++;
  }
...
static int _wrap_complex_matrix___getitem(lua_State* L) {
  int SWIG_arg = 0;
  std::vector< std::vector< std::complex< float > > > *arg1 = (std::vector< std::vector< std::complex< float > > > *) 0 ;
  unsigned int arg2 ;
  SwigValueWrapper< std::vector< std::complex< float > > > result;
  
  SWIG_check_num_args("std::vector< std::vector< std::complex< float > > >::__getitem__",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("std::vector< std::vector< std::complex< float > > >::__getitem__",1,"std::vector< std::vector< std::complex< float > > > *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("std::vector< std::vector< std::complex< float > > >::__getitem__",2,"unsigned int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_std__vectorT_std__vectorT_std__complexT_float_t_t_t,0))){
    SWIG_fail_ptr("complex_matrix___getitem",1,SWIGTYPE_p_std__vectorT_std__vectorT_std__complexT_float_t_t_t);
  }
  
  SWIG_contract_assert((lua_tonumber(L,2)>=0),"number must not be negative");
  arg2 = (unsigned int)lua_tonumber(L, 2);
  try {
    result = std_vector_Sl_std_vector_Sl_std_complex_Sl_float_Sg__Sg__Sg____getitem____SWIG(arg1,arg2);
  } catch(std::out_of_range &_e) {
    SWIG_exception(SWIG_IndexError, (&_e)->what());
  }
  {
...
static int _wrap_complex_matrix___setitem(lua_State* L) {
  int SWIG_arg = 0;
  std::vector< std::vector< std::complex< float > > > *arg1 = (std::vector< std::vector< std::complex< float > > > *) 0 ;
  unsigned int arg2 ;
  SwigValueWrapper< std::vector< std::complex< float > > > arg3 ;
  std::vector< std::complex< float > > *argp3 ;
  
  SWIG_check_num_args("std::vector< std::vector< std::complex< float > > >::__setitem__",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("std::vector< std::vector< std::complex< float > > >::__setitem__",1,"std::vector< std::vector< std::complex< float > > > *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("std::vector< std::vector< std::complex< float > > >::__setitem__",2,"unsigned int");
  if(!lua_isuserdata(L,3)) SWIG_fail_arg("std::vector< std::vector< std::complex< float > > >::__setitem__",3,"std::vector< std::complex< float > >");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_std__vectorT_std__vectorT_std__complexT_float_t_t_t,0))){
    SWIG_fail_ptr("complex_matrix___setitem",1,SWIGTYPE_p_std__vectorT_std__vectorT_std__complexT_float_t_t_t);
  }
  
  SWIG_contract_assert((lua_tonumber(L,2)>=0),"number must not be negative");
  arg2 = (unsigned int)lua_tonumber(L, 2);
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,3,(void**)&argp3,SWIGTYPE_p_std__vectorT_std__complexT_float_t_t,0))){
    SWIG_fail_ptr("complex_matrix___setitem",3,SWIGTYPE_p_std__vectorT_std__complexT_float_t_t);
  }
  arg3 = *argp3;
  
  try {
    std_vector_Sl_std_vector_Sl_std_complex_Sl_float_Sg__Sg__Sg____setitem____SWIG(arg1,arg2,arg3);
  } catch(std::out_of_range &_e) {
    SWIG_exception(SWIG_IndexError, (&_e)->what());
  }
...
std::vector< std::vector< std::complex< float > > > *arg1 = (std::vector< std::vector< std::complex< float > > > *) obj;
delete arg1;
}
...
static swig_lua_method swig_complex_matrix_methods[]= {
    ...
    { "__getitem", _wrap_complex_matrix___getitem},
    { "__setitem", _wrap_complex_matrix___setitem},
    {0,0}
};
...
static swig_lua_class _wrap_class_complex_matrix = { "complex_matrix", "complex_matrix", &SWIGTYPE_p_std__vectorT_std__vectorT_std__complexT_float_t_t_t,_proxy__wrap_new_complex_matrix, swig_delete_complex_matrix, swig_complex_matrix_methods, swig_complex_matrix_attributes, &swig_complex_matrix_Sf_SwigStatic, swig_complex_matrix_meta, swig_complex_matrix_bases, swig_complex_matrix_base_names };

static int _wrap_pad(lua_State* L) {
  int SWIG_arg = 0;
  librosa::Vectorf *arg1 = 0 ;
  int arg2 ;
  int arg3 ;
  std::string *arg4 = 0 ;
  float arg5 ;
  librosa::Vectorf result;
  
  SWIG_check_num_args("librosa::internal::pad",5,5)
  if(!lua_isuserdata(L,1)) SWIG_fail_arg("librosa::internal::pad",1,"librosa::Vectorf &");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("librosa::internal::pad",2,"int");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("librosa::internal::pad",3,"int");
  if(!lua_isuserdata(L,4)) SWIG_fail_arg("librosa::internal::pad",4,"std::string const &");
  if(!lua_isnumber(L,5)) SWIG_fail_arg("librosa::internal::pad",5,"float");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Eigen__MatrixT_float_1_Eigen__Dynamic_Eigen__RowMajor_t,0))){
    SWIG_fail_ptr("pad",1,SWIGTYPE_p_Eigen__MatrixT_float_1_Eigen__Dynamic_Eigen__RowMajor_t);
  }
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,4,(void**)&arg4,SWIGTYPE_p_std__string,0))){
    SWIG_fail_ptr("pad",4,SWIGTYPE_p_std__string);
  }
  
  arg5 = (float)lua_tonumber(L, 5);
  result = librosa::internal::pad(*arg1,arg2,arg3,(std::string const &)*arg4,arg5);
  {
    librosa::Vectorf * resultptr = new librosa::Vectorf((const librosa::Vectorf &) result);
...
static int _wrap_stft(lua_State* L) {
  ...
  bool arg5 ;
  std::string *arg6 = 0 ;
  librosa::Matrixcf result;
  
  SWIG_check_num_args("librosa::internal::stft",6,6)
  if(!lua_isuserdata(L,1)) SWIG_fail_arg("librosa::internal::stft",1,"librosa::Vectorf &");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("librosa::internal::stft",2,"int");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("librosa::internal::stft",3,"int");
  if(!lua_isuserdata(L,4)) SWIG_fail_arg("librosa::internal::stft",4,"std::string const &");
  if(!lua_isboolean(L,5)) SWIG_fail_arg("librosa::internal::stft",5,"bool");
  if(!lua_isuserdata(L,6)) SWIG_fail_arg("librosa::internal::stft",6,"std::string const &");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Eigen__MatrixT_float_1_Eigen__Dynamic_Eigen__RowMajor_t,0))){
    SWIG_fail_ptr("stft",1,SWIGTYPE_p_Eigen__MatrixT_float_1_Eigen__Dynamic_Eigen__RowMajor_t);
  }
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,4,(void**)&arg4,SWIGTYPE_p_std__string,0))){
    SWIG_fail_ptr("stft",4,SWIGTYPE_p_std__string);
  }
  
  arg5 = (lua_toboolean(L, 5)!=0);
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,6,(void**)&arg6,SWIGTYPE_p_std__string,0))){
    SWIG_fail_ptr("stft",6,SWIGTYPE_p_std__string);
  }
  
  result = librosa::internal::stft(*arg1,arg2,arg3,(std::string const &)*arg4,arg5,(std::string const &)*arg6);
  {
    librosa::Matrixcf * resultptr = new librosa::Matrixcf((const librosa::Matrixcf &) result);
    SWIG_NewPointerObj(L,(void *) resultptr,SWIGTYPE_p_Eigen__MatrixT_std__complexT_float_t_Eigen__Dynamic_Eigen__Dynamic_Eigen__RowMajor_t,1); SWIG_arg++;
  }
  return SWIG_arg;
...
static int _wrap_spectrogram__SWIG_0(lua_State* L) {
  int SWIG_arg = 0;
  librosa::Matrixcf *arg1 = 0 ;
  float arg2 ;
  librosa::Matrixf result;
  
  SWIG_check_num_args("librosa::internal::spectrogram",2,2)
  if(!lua_isuserdata(L,1)) SWIG_fail_arg("librosa::internal::spectrogram",1,"librosa::Matrixcf &");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("librosa::internal::spectrogram",2,"float");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Eigen__MatrixT_std__complexT_float_t_Eigen__Dynamic_Eigen__Dynamic_Eigen__RowMajor_t,0))){
    SWIG_fail_ptr("spectrogram",1,SWIGTYPE_p_Eigen__MatrixT_std__complexT_float_t_Eigen__Dynamic_Eigen__Dynamic_Eigen__RowMajor_t);
  }
  
  arg2 = (float)lua_tonumber(L, 2);
  result = librosa::internal::spectrogram(*arg1,arg2);
  {
    librosa::Matrixf * resultptr = new librosa::Matrixf((const librosa::Matrixf &) result);
    SWIG_NewPointerObj(L,(void *) resultptr,SWIGTYPE_p_Eigen__MatrixT_float_Eigen__Dynamic_Eigen__Dynamic_Eigen__RowMajor_t,1); SWIG_arg++;
  }
  return SWIG_arg;
...
static int _wrap_spectrogram__SWIG_1(lua_State* L) {
  int SWIG_arg = 0;
  librosa::Matrixcf *arg1 = 0 ;
  librosa::Matrixf result;
  
  SWIG_check_num_args("librosa::internal::spectrogram",1,1)
  if(!lua_isuserdata(L,1)) SWIG_fail_arg("librosa::internal::spectrogram",1,"librosa::Matrixcf &");
  ...
  result = librosa::internal::spectrogram(*arg1);
  {
    librosa::Matrixf * resultptr = new librosa::Matrixf((const librosa::Matrixf &) result);
    SWIG_NewPointerObj(L,(void *) resultptr,SWIGTYPE_p_Eigen__MatrixT_float_Eigen__Dynamic_Eigen__Dynamic_Eigen__RowMajor_t,1); SWIG_arg++;
  }
...
static int _wrap_spectrogram(lua_State* L) {
  int argc;
  int argv[3]={
    1,2,3
  };
  ...
  if (argc == 1) {
    ...
    {
      void *ptr;
      if (lua_isuserdata(L,argv[0])==0 || SWIG_ConvertPtr(L,argv[0], (void **) &ptr, SWIGTYPE_p_Eigen__MatrixT_std__complexT_float_t_Eigen__Dynamic_Eigen__Dynamic_Eigen__RowMajor_t, SWIG_POINTER_NO_NULL)) {
        _v = 0;
      } else {
        _v = 1;
      }
    ...
    if (_v) {
      return _wrap_spectrogram__SWIG_1(L);
    }
  }
  if (argc == 2) {
    int _v = 0;
    ...
    if (_v) {
      ...
      if (_v) {
        return _wrap_spectrogram__SWIG_0(L);
      }
    }
  }
  
  SWIG_Lua_pusherrstring(L,"Wrong arguments for overloaded function 'spectrogram'\n"
    "  Possible C/C++ prototypes are:\n"
    "    librosa::internal::spectrogram(librosa::Matrixcf &,float)\n"
    "    librosa::internal::spectrogram(librosa::Matrixcf &)\n");
  lua_error(L);return 0;
}


static int _wrap_melfilter(lua_State* L) {
  int SWIG_arg = 0;
  int arg1 ;
  int arg2 ;
  int arg3 ;
  ...
  SWIG_check_num_args("librosa::internal::melfilter",5,5)
  if(!lua_isnumber(L,1)) SWIG_fail_arg("librosa::internal::melfilter",1,"int");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("librosa::internal::melfilter",2,"int");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("librosa::internal::melfilter",3,"int");
  if(!lua_isnumber(L,4)) SWIG_fail_arg("librosa::internal::melfilter",4,"int");
  if(!lua_isnumber(L,5)) SWIG_fail_arg("librosa::internal::melfilter",5,"int");
  arg1 = (int)lua_tonumber(L, 1);
  arg2 = (int)lua_tonumber(L, 2);
  arg3 = (int)lua_tonumber(L, 3);
  arg4 = (int)lua_tonumber(L, 4);
  arg5 = (int)lua_tonumber(L, 5);
  result = librosa::internal::melfilter(arg1,arg2,arg3,arg4,arg5);
  {
    librosa::Matrixf * resultptr = new librosa::Matrixf((const librosa::Matrixf &) result);
    SWIG_NewPointerObj(L,(void *) resultptr,SWIGTYPE_p_Eigen__MatrixT_float_Eigen__Dynamic_Eigen__Dynamic_Eigen__RowMajor_t,1); SWIG_arg++;
  }
...
static int _wrap_melspectrogram(lua_State* L) {
  int SWIG_arg = 0;
  librosa::Vectorf *arg1 = 0 ;
  int arg2 ;
  int arg3 ;
  ...
  SWIG_check_num_args("librosa::internal::melspectrogram",11,11)
  if(!lua_isuserdata(L,1)) SWIG_fail_arg("librosa::internal::melspectrogram",1,"librosa::Vectorf &");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("librosa::internal::melspectrogram",2,"int");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("librosa::internal::melspectrogram",3,"int");
  if(!lua_isnumber(L,4)) SWIG_fail_arg("librosa::internal::melspectrogram",4,"int");
  if(!lua_isuserdata(L,5)) SWIG_fail_arg("librosa::internal::melspectrogram",5,"std::string const &");
  if(!lua_isboolean(L,6)) SWIG_fail_arg("librosa::internal::melspectrogram",6,"bool");
  if(!lua_isuserdata(L,7)) SWIG_fail_arg("librosa::internal::melspectrogram",7,"std::string const &");
  if(!lua_isnumber(L,8)) SWIG_fail_arg("librosa::internal::melspectrogram",8,"float");
  if(!lua_isnumber(L,9)) SWIG_fail_arg("librosa::internal::melspectrogram",9,"int");
  if(!lua_isnumber(L,10)) SWIG_fail_arg("librosa::internal::melspectrogram",10,"int");
  if(!lua_isnumber(L,11)) SWIG_fail_arg("librosa::internal::melspectrogram",11,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Eigen__MatrixT_float_1_Eigen__Dynamic_Eigen__RowMajor_t,0))){
    SWIG_fail_ptr("melspectrogram",1,SWIGTYPE_p_Eigen__MatrixT_float_1_Eigen__Dynamic_Eigen__RowMajor_t);
  }
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,5,(void**)&arg5,SWIGTYPE_p_std__string,0))){
    SWIG_fail_ptr("melspectrogram",5,SWIGTYPE_p_std__string);
  }
  
  arg6 = (lua_toboolean(L, 6)!=0);
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,7,(void**)&arg7,SWIGTYPE_p_std__string,0))){
    SWIG_fail_ptr("melspectrogram",7,SWIGTYPE_p_std__string);
  }
  ...
  result = librosa::internal::melspectrogram(*arg1,arg2,arg3,arg4,(std::string const &)*arg5,arg6,(std::string const &)*arg7,arg8,arg9,arg10,arg11);
  {
    librosa::Matrixf * resultptr = new librosa::Matrixf((const librosa::Matrixf &) result);
    SWIG_NewPointerObj(L,(void *) resultptr,SWIGTYPE_p_Eigen__MatrixT_float_Eigen__Dynamic_Eigen__Dynamic_Eigen__RowMajor_t,1); SWIG_arg++;
  }
...
static int _wrap_power2db(lua_State* L) {
  int SWIG_arg = 0;
  librosa::Matrixf *arg1 = 0 ;
  librosa::Matrixf result;
  
  SWIG_check_num_args("librosa::internal::power2db",1,1)
  if(!lua_isuserdata(L,1)) SWIG_fail_arg("librosa::internal::power2db",1,"librosa::Matrixf &");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Eigen__MatrixT_float_Eigen__Dynamic_Eigen__Dynamic_Eigen__RowMajor_t,0))){
    SWIG_fail_ptr("power2db",1,SWIGTYPE_p_Eigen__MatrixT_float_Eigen__Dynamic_Eigen__Dynamic_Eigen__RowMajor_t);
  }
  
  result = librosa::internal::power2db(*arg1);
  {
    librosa::Matrixf * resultptr = new librosa::Matrixf((const librosa::Matrixf &) result);
    SWIG_NewPointerObj(L,(void *) resultptr,SWIGTYPE_p_Eigen__MatrixT_float_Eigen__Dynamic_Eigen__Dynamic_Eigen__RowMajor_t,1); SWIG_arg++;
  }
...
static int _wrap_dct(lua_State* L) {
  int SWIG_arg = 0;
  librosa::Matrixf *arg1 = 0 ;
  bool arg2 ;
  int arg3 ;
  ...
  SWIG_check_num_args("librosa::internal::dct",3,3)
  if(!lua_isuserdata(L,1)) SWIG_fail_arg("librosa::internal::dct",1,"librosa::Matrixf &");
  if(!lua_isboolean(L,2)) SWIG_fail_arg("librosa::internal::dct",2,"bool");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("librosa::internal::dct",3,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_Eigen__MatrixT_float_Eigen__Dynamic_Eigen__Dynamic_Eigen__RowMajor_t,0))){
    SWIG_fail_ptr("dct",1,SWIGTYPE_p_Eigen__MatrixT_float_Eigen__Dynamic_Eigen__Dynamic_Eigen__RowMajor_t);
  }
  
  arg2 = (lua_toboolean(L, 2)!=0);
  arg3 = (int)lua_tonumber(L, 3);
  result = librosa::internal::dct(*arg1,arg2,arg3);
  {
    librosa::Matrixf * resultptr = new librosa::Matrixf((const librosa::Matrixf &) result);
    SWIG_NewPointerObj(L,(void *) resultptr,SWIGTYPE_p_Eigen__MatrixT_float_Eigen__Dynamic_Eigen__Dynamic_Eigen__RowMajor_t,1); SWIG_arg++;
  }
...
static int _wrap_Feature_stft(lua_State* L) {
  int SWIG_arg = 0;
  std::vector< float > *arg1 = 0 ;
  int arg2 ;
  int arg3 ;
  ...
  SWIG_check_num_args("librosa::Feature::stft",6,6)
  if(!lua_isuserdata(L,1)) SWIG_fail_arg("librosa::Feature::stft",1,"std::vector< float > &");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("librosa::Feature::stft",2,"int");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("librosa::Feature::stft",3,"int");
  if(!lua_isuserdata(L,4)) SWIG_fail_arg("librosa::Feature::stft",4,"std::string const &");
  if(!lua_isboolean(L,5)) SWIG_fail_arg("librosa::Feature::stft",5,"bool");
  if(!lua_isuserdata(L,6)) SWIG_fail_arg("librosa::Feature::stft",6,"std::string const &");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_std__vectorT_float_t,0))){
    SWIG_fail_ptr("Feature_stft",1,SWIGTYPE_p_std__vectorT_float_t);
  }
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,4,(void**)&arg4,SWIGTYPE_p_std__string,0))){
    SWIG_fail_ptr("Feature_stft",4,SWIGTYPE_p_std__string);
  }
  
  arg5 = (lua_toboolean(L, 5)!=0);
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,6,(void**)&arg6,SWIGTYPE_p_std__string,0))){
    SWIG_fail_ptr("Feature_stft",6,SWIGTYPE_p_std__string);
  }
  
  result = librosa::Feature::stft(*arg1,arg2,arg3,(std::string const &)*arg4,arg5,(std::string const &)*arg6);
  {
    std::vector< std::vector< std::complex< float > > > * resultptr = new std::vector< std::vector< std::complex< float > > >((const std::vector< std::vector< std::complex< float > > > &) result);
    SWIG_NewPointerObj(L,(void *) resultptr,SWIGTYPE_p_std__vectorT_std__vectorT_std__complexT_float_t_t_t,1); SWIG_arg++;
  }
  return SWIG_arg;
...
static int _wrap_Feature_melspectrogram(lua_State* L) {
  int SWIG_arg = 0;
  std::vector< float > *arg1 = 0 ;
  int arg2 ;
  int arg3 ;
  ...
  SWIG_check_num_args("librosa::Feature::melspectrogram",11,11)
  if(!lua_isuserdata(L,1)) SWIG_fail_arg("librosa::Feature::melspectrogram",1,"std::vector< float > &");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("librosa::Feature::melspectrogram",2,"int");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("librosa::Feature::melspectrogram",3,"int");
  if(!lua_isnumber(L,4)) SWIG_fail_arg("librosa::Feature::melspectrogram",4,"int");
  if(!lua_isuserdata(L,5)) SWIG_fail_arg("librosa::Feature::melspectrogram",5,"std::string const &");
  if(!lua_isboolean(L,6)) SWIG_fail_arg("librosa::Feature::melspectrogram",6,"bool");
  if(!lua_isuserdata(L,7)) SWIG_fail_arg("librosa::Feature::melspectrogram",7,"std::string const &");
  if(!lua_isnumber(L,8)) SWIG_fail_arg("librosa::Feature::melspectrogram",8,"float");
  if(!lua_isnumber(L,9)) SWIG_fail_arg("librosa::Feature::melspectrogram",9,"int");
  if(!lua_isnumber(L,10)) SWIG_fail_arg("librosa::Feature::melspectrogram",10,"int");
  if(!lua_isnumber(L,11)) SWIG_fail_arg("librosa::Feature::melspectrogram",11,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_std__vectorT_float_t,0))){
    SWIG_fail_ptr("Feature_melspectrogram",1,SWIGTYPE_p_std__vectorT_float_t);
  }
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,5,(void**)&arg5,SWIGTYPE_p_std__string,0))){
    SWIG_fail_ptr("Feature_melspectrogram",5,SWIGTYPE_p_std__string);
  }
  
  arg6 = (lua_toboolean(L, 6)!=0);
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,7,(void**)&arg7,SWIGTYPE_p_std__string,0))){
    SWIG_fail_ptr("Feature_melspectrogram",7,SWIGTYPE_p_std__string);
  }
  ...
  arg10 = (int)lua_tonumber(L, 10);
  arg11 = (int)lua_tonumber(L, 11);
  result = librosa::Feature::melspectrogram(*arg1,arg2,arg3,arg4,(std::string const &)*arg5,arg6,(std::string const &)*arg7,arg8,arg9,arg10,arg11);
  {
    std::vector< std::vector< float > > * resultptr = new std::vector< std::vector< float > >((const std::vector< std::vector< float > > &) result);
...
static int _wrap_Feature_mfcc(lua_State* L) {
  int SWIG_arg = 0;
  std::vector< float > *arg1 = 0 ;
  int arg2 ;
  int arg3 ;
  ...
  SWIG_check_num_args("librosa::Feature::mfcc",14,14)
  if(!lua_isuserdata(L,1)) SWIG_fail_arg("librosa::Feature::mfcc",1,"std::vector< float > &");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("librosa::Feature::mfcc",2,"int");
  if(!lua_isnumber(L,3)) SWIG_fail_arg("librosa::Feature::mfcc",3,"int");
  if(!lua_isnumber(L,4)) SWIG_fail_arg("librosa::Feature::mfcc",4,"int");
  if(!lua_isuserdata(L,5)) SWIG_fail_arg("librosa::Feature::mfcc",5,"std::string const &");
  if(!lua_isboolean(L,6)) SWIG_fail_arg("librosa::Feature::mfcc",6,"bool");
  if(!lua_isuserdata(L,7)) SWIG_fail_arg("librosa::Feature::mfcc",7,"std::string const &");
  if(!lua_isnumber(L,8)) SWIG_fail_arg("librosa::Feature::mfcc",8,"float");
  if(!lua_isnumber(L,9)) SWIG_fail_arg("librosa::Feature::mfcc",9,"int");
  if(!lua_isnumber(L,10)) SWIG_fail_arg("librosa::Feature::mfcc",10,"int");
  if(!lua_isnumber(L,11)) SWIG_fail_arg("librosa::Feature::mfcc",11,"int");
  if(!lua_isnumber(L,12)) SWIG_fail_arg("librosa::Feature::mfcc",12,"int");
  if(!lua_isboolean(L,13)) SWIG_fail_arg("librosa::Feature::mfcc",13,"bool");
  if(!lua_isnumber(L,14)) SWIG_fail_arg("librosa::Feature::mfcc",14,"int");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_std__vectorT_float_t,0))){
    SWIG_fail_ptr("Feature_mfcc",1,SWIGTYPE_p_std__vectorT_float_t);
  }
  ...
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,5,(void**)&arg5,SWIGTYPE_p_std__string,0))){
    SWIG_fail_ptr("Feature_mfcc",5,SWIGTYPE_p_std__string);
  }
  
  arg6 = (lua_toboolean(L, 6)!=0);
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,7,(void**)&arg7,SWIGTYPE_p_std__string,0))){
    SWIG_fail_ptr("Feature_mfcc",7,SWIGTYPE_p_std__string);
  }
  ...
  arg13 = (lua_toboolean(L, 13)!=0);
  arg14 = (int)lua_tonumber(L, 14);
  result = librosa::Feature::mfcc(*arg1,arg2,arg3,arg4,(std::string const &)*arg5,arg6,(std::string const &)*arg7,arg8,arg9,arg10,arg11,arg12,arg13,arg14);
  {
    std::vector< std::vector< float > > * resultptr = new std::vector< std::vector< float > >((const std::vector< std::vector< float > > &) result);
    SWIG_NewPointerObj(L,(void *) resultptr,SWIGTYPE_p_std__vectorT_std__vectorT_float_t_t,1); SWIG_arg++;
  }
...
static int _wrap_new_Feature(lua_State* L) {
  int SWIG_arg = 0;
  librosa::Feature *result = 0 ;
  
  SWIG_check_num_args("librosa::Feature::Feature",0,0)
  result = (librosa::Feature *)new librosa::Feature();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_librosa__Feature,1); SWIG_arg++; 
  return SWIG_arg;
...
static void swig_delete_Feature(void *obj) {
librosa::Feature *arg1 = (librosa::Feature *) obj;
delete arg1;
}
static int _proxy__wrap_new_Feature(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_Feature);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_Feature_attributes[] = {
    {0,0,0}
};
static swig_lua_method swig_Feature_methods[]= {
    {0,0}
};
static swig_lua_method swig_Feature_meta[] = {
    {0,0}
};

static swig_lua_attribute swig_Feature_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_Feature_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_Feature_Sf_SwigStatic_methods[]= {
    { "stft", _wrap_Feature_stft},
    { "melspectrogram", _wrap_Feature_melspectrogram},
    { "mfcc", _wrap_Feature_mfcc},
    {0,0}
};
static swig_lua_class* swig_Feature_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_Feature_Sf_SwigStatic = {
    "Feature",
    swig_Feature_Sf_SwigStatic_methods,
    swig_Feature_Sf_SwigStatic_attributes,
    swig_Feature_Sf_SwigStatic_constants,
    swig_Feature_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_Feature_bases[] = {0};
static const char *swig_Feature_base_names[] = {0};
static swig_lua_class _wrap_class_Feature = { "Feature", "Feature", &SWIGTYPE_p_librosa__Feature,_proxy__wrap_new_Feature, swig_delete_Feature, swig_Feature_methods, swig_Feature_attributes, &swig_Feature_Sf_SwigStatic, swig_Feature_meta, swig_Feature_bases, swig_Feature_base_names };
...
static swig_lua_method swig_SwigModule_methods[]= {
    { "pad", _wrap_pad},
    { "stft", _wrap_stft},
    { "spectrogram", _wrap_spectrogram},
    { "melfilter", _wrap_melfilter},
    { "melspectrogram", _wrap_melspectrogram},
    { "power2db", _wrap_power2db},
    { "dct", _wrap_dct},
    { "Feature_stft", _wrap_Feature_stft},
    { "Feature_melspectrogram", _wrap_Feature_melspectrogram},
    { "Feature_mfcc", _wrap_Feature_mfcc},
    {0,0}
};
...
static swig_type_info _swigt__p_Eigen__MatrixT_float_1_Eigen__Dynamic_Eigen__RowMajor_t = {"_p_Eigen__MatrixT_float_1_Eigen__Dynamic_Eigen__RowMajor_t", "Eigen::Matrix< float,1,Eigen::Dynamic,Eigen::RowMajor > *|librosa::Vectorf *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_Eigen__MatrixT_float_Eigen__Dynamic_Eigen__Dynamic_Eigen__RowMajor_t = {"_p_Eigen__MatrixT_float_Eigen__Dynamic_Eigen__Dynamic_Eigen__RowMajor_t", "Eigen::Matrix< float,Eigen::Dynamic,Eigen::Dynamic,Eigen::RowMajor > *|librosa::Matrixf *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_Eigen__MatrixT_std__complexT_float_t_1_Eigen__Dynamic_Eigen__RowMajor_t = {"_p_Eigen__MatrixT_std__complexT_float_t_1_Eigen__Dynamic_Eigen__RowMajor_t", "librosa::Vectorcf *|Eigen::Matrix< std::complex< float >,1,Eigen::Dynamic,Eigen::RowMajor > *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_Eigen__MatrixT_std__complexT_float_t_Eigen__Dynamic_Eigen__Dynamic_Eigen__RowMajor_t = {"_p_Eigen__MatrixT_std__complexT_float_t_Eigen__Dynamic_Eigen__Dynamic_Eigen__RowMajor_t", "Eigen::Matrix< std::complex< float >,Eigen::Dynamic,Eigen::Dynamic,Eigen::RowMajor > *|librosa::Matrixcf *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_difference_type = {"_p_difference_type", "difference_type *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_librosa__Feature = {"_p_librosa__Feature", "librosa::Feature *", 0, 0, (void*)&_wrap_class_Feature, 0};
...
static swig_type_info _swigt__p_std__vectorT_std__vectorT_std__complexT_float_t_t_t = {"_p_std__vectorT_std__vectorT_std__complexT_float_t_t_t", "std::vector< std::vector< std::complex< float > > > *", 0, 0, (void*)&_wrap_class_complex_matrix, 0};
static swig_type_info _swigt__p_value_type = {"_p_value_type", "value_type *", 0, 0, (void*)0, 0};

static swig_type_info *swig_type_initial[] = {
  &_swigt__p_Eigen__MatrixT_float_1_Eigen__Dynamic_Eigen__RowMajor_t,
  &_swigt__p_Eigen__MatrixT_float_Eigen__Dynamic_Eigen__Dynamic_Eigen__RowMajor_t,
  &_swigt__p_Eigen__MatrixT_std__complexT_float_t_1_Eigen__Dynamic_Eigen__RowMajor_t,
  &_swigt__p_Eigen__MatrixT_std__complexT_float_t_Eigen__Dynamic_Eigen__Dynamic_Eigen__RowMajor_t,
  &_swigt__p_difference_type,
  &_swigt__p_librosa__Feature,
  &_swigt__p_size_type,
  ...
  &_swigt__p_std__vectorT_std__vectorT_std__complexT_float_t_t_t,
...
static swig_cast_info _swigc__p_Eigen__MatrixT_float_Eigen__Dynamic_Eigen__Dynamic_Eigen__RowMajor_t[] = {  {&_swigt__p_Eigen__MatrixT_float_Eigen__Dynamic_Eigen__Dynamic_Eigen__RowMajor_t, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_Eigen__MatrixT_std__complexT_float_t_Eigen__Dynamic_Eigen__Dynamic_Eigen__RowMajor_t[] = {  {&_swigt__p_Eigen__MatrixT_std__complexT_float_t_Eigen__Dynamic_Eigen__Dynamic_Eigen__RowMajor_t, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_difference_type[] = {  {&_swigt__p_difference_type, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_librosa__Feature[] = {  {&_swigt__p_librosa__Feature, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_std__vectorT_std__vectorT_std__complexT_float_t_t_t[] = {  {&_swigt__p_std__vectorT_std__vectorT_std__complexT_float_t_t_t, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_value_type[] = {  {&_swigt__p_value_type, 0, 0, 0},{0, 0, 0, 0}};

static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_Eigen__MatrixT_float_1_Eigen__Dynamic_Eigen__RowMajor_t,
  _swigc__p_Eigen__MatrixT_float_Eigen__Dynamic_Eigen__Dynamic_Eigen__RowMajor_t,
  _swigc__p_Eigen__MatrixT_std__complexT_float_t_1_Eigen__Dynamic_Eigen__RowMajor_t,
  _swigc__p_Eigen__MatrixT_std__complexT_float_t_Eigen__Dynamic_Eigen__Dynamic_Eigen__RowMajor_t,
  _swigc__p_difference_type,
  _swigc__p_librosa__Feature,
  _swigc__p_size_type,
  ...
  _swigc__p_std__vectorT_std__vectorT_std__complexT_float_t_t_t,
